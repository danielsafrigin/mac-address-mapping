...
public class LocationFilterByRangeTest {
	LocationFilterByRange filter;

	@Before
	public void setUp() throws Exception {
		filter = new LocationFilterByRange("32.1", "35.21", "688.0", "32.11", "35.22", "690.0", "or");
	}
	...
	public void testGetStartLatitude() {
		...
		double actual = filter.getStartLatitude();
		assertEquals(actual, expected, 0);
	}

	@Test
	public void testGetStartLongtitude() {
		double expected = 35.21;
		double actual = filter.getStartLongtitude();
		assertEquals(actual, expected, 0);
	}

	@Test
	public void testGetStartAltitude() {
		double expected = 688.0;
		double actual = filter.getStartAltitude();
		assertEquals(actual, expected, 0);
	}

	@Test
	public void testGetEndLatitude() {
		double expected = 32.11;
		double actual = filter.getEndLatitude();
		assertEquals(actual, expected, 0);
	}

	@Test
	public void testGetEndLongtitude() {
		double expected = 35.22;
		double actual = filter.getEndLongtitude();
		assertEquals(actual, expected, 0);
	}

	@Test
	public void testGetEndAltitude() {
		double expected = 690.0;
		double actual = filter.getEndAltitude();
		assertEquals(actual, expected, 0);
	}
	...
	public void testFilter() {
		...
		String[] s3 = ("2017-12-03 08:46:58,model=Lenovo PB2-690Y_device=PB2PRO," + "32.00389461,35.11035436,695.0"
				+ ",1,HelpDesk,60:e3:27:7b:e0:98,4,-87.0").split(",");
		WifiSample t3 = new WifiSample(s3);

		String[] s4 = ("2017-12-03 08:48:02,model=Lenovo PB2-690Y_device=PB2PRO," + "32.50497773,35.11118029,694.0,"
		...
		assertTrue(list2.size() == 1 && list2.get(0).toString().equals(t2.toString()));
	}
