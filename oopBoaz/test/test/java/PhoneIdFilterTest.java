...
public class PhoneIdFilterTest {
	PhoneIdFilter filter;

	@Before
	public void setUp() throws Exception {
		filter = new PhoneIdFilter("Redmi 4A", "andnot");
	}

	@Test
	public void testGetOperator() {
		String expected = "andnot";
	...
	public void testGetPhoneId() {
		String expected = "Redmi 4A";
		String actual = filter.getPhoneId();
		assertEquals(actual, expected);
	}

	@Test
	public void testToString() {
		String expected = "Device(" + "Redmi 4A" + ")";
		if (filter.getOperator().contains("not"))
			expected = "!" + expected;
		if (filter.getOperator().contains("and"))
			expected = "& " + expected;
		else
			expected = "| " + expected;
	...
	public void testFilter() {
		...
		assertTrue(list2.size() == 1 && list2.get(0).toString().equals(t3.toString()));
	}
